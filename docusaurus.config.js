...
const config = {
  ...
  organizationName: 'howlsocial', // Usually your GitHub org/user name.
  projectName: 'howldocs', // Usually your repo name.
  trailingSlash: false,
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/howlsocial/howldocs/tree/main/docs/',
        },
        blog: {
